...
import { createMarcaVeiculoWithResponse } from './MarcaVeiculoService';
import { extractFieldErrors, formatApiErrors } from '../../services/apiService';

interface MarcaVeiculoModalProps {
    open: boolean;
    onClose: () => void;
    onSuccess: (marca: any) => void;
}

export default function MarcaVeiculoModal({ open, onClose, onSuccess }: MarcaVeiculoModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const result = await createMarcaVeiculoWithResponse({
                nome: nome.trim(),
            });
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    ...
                    <Box>
                        <Typography variant="h6" sx={{ fontWeight: 600, lineHeight: 1.2 }}>
                            Nova Marca de Veículo
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                            Digite o nome da marca para cadastrar
                        </Typography>
                    </Box>
                </Box>
                <IconButton
